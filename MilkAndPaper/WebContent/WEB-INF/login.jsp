...
<div class="content">
	...
	<form class="register-form" action="index.html" method="post">
		...
		<div class="form-group">
			...
			<div class="input-icon">
				<i class="fa fa-font"></i>
				<input class="form-control placeholder-no-fix" type="text" placeholder="Last Name" name="lasttname"/>
			</div>
		</div>
		<div class="form-group">
			<!--ie8, ie9 does not support html5 placeholder, so we just show field title for that-->
		...
		<div class="form-group">
			<label class="control-label visible-ie8 visible-ie9">Block Name</label>
		...
		<div class="form-group">
			<label class="control-label visible-ie8 visible-ie9">Floor Number</label>
			<select name="country" id="select2_sample4" class="select2 form-control">
				<option value=""></option>
		...
		<div class="form-group">
			<label class="control-label visible-ie8 visible-ie9">Flat Number</label>
			<select name="country" id="select2_sample4" class="select2 form-control">
				<option value=""></option>
